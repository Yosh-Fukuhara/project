        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition mb-6">
            ...
            <div class="px-6 pb-6 -mt-10 relative z-10">
                <div class="flex flex-col sm:flex-row sm:items-end gap-4">
                    ...
                    <div class="flex flex-col gap-2 mt-2 sm:mt-8">
                        <?php
                        $msgUrl = "messages.php?user=" . urlencode($viewedUser['user_id']);
                        ?>
                        <a href="<?php echo $msgUrl; ?>"
                           class="flex items-center gap-2 bg-blue-900 text-white px-5 py-2 rounded-xl font-semibold hover:bg-blue-800 transition text-sm">
                            ...
                            Message (User ID: <?php echo htmlspecialchars($viewedUser['user_id']); ?>)
                        </a>
                        <p class="text-xs text-gray-500">Link URL: <?php echo htmlspecialchars($msgUrl); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
