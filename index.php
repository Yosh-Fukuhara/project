            ...
            ?>
                <div class="bg-white rounded-xl shadow-md mb-4 overflow-hidden" data-post-card data-post-id="<?php echo htmlspecialchars($pid); ?>">
                    ...
                    <div class="border-t border-gray-100 px-4 py-3 bg-blue-50">
                        <button class="apply-modal-btn w-full bg-pink-700 hover:bg-pink-800 text-white font-bold py-2 rounded-xl transition text-sm" data-post-id="<?php echo htmlspecialchars($pid); ?>">
                            Apply Now
                        </button>
                    </div>
                    <?php endif; ?>
